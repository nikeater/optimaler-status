...
Everything else here is a **copy** taken at part 11, byte-identical to its
workspace original at the time of the copy. The one exception is
`technical-spec.md`, which carries an added note at the top saying which of its
cross-references do not resolve in this repository.
